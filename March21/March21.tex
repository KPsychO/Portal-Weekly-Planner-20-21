...
\begin{figure}[H]
  ...
  \begin{subfigure}[l]{0.5\textwidth}
    \includegraphics[height=0.35\textheight]{Sources/PortalNumbers/3.jpg}
  \end{subfigure}
  
\end{figure}

\rmfamily {\fontsize{16}{20}\selectfont 03/12} \hfill \sffamily\textbf{\fontsize{16}{20}\selectfont March} \par
\rule{\linewidth}{0.1cm} \par
...
\begin{subfigure}[l]{0.5\textwidth}
  ...
  \end{subfigure}
  \begin{subfigure}[l]{0.5\textwidth}
    \includegraphics[width=\textwidth]{Sources/MonthViews/April21.jpg}
  \end{subfigure}
\end{figure}
