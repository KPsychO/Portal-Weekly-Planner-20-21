...
\begin{figure}[H]
  ...
  \begin{subfigure}[l]{0.5\textwidth}
    \includegraphics[height=0.35\textheight]{Sources/PortalNumbers/4.jpg}
  \end{subfigure}
  
\end{figure}

\rmfamily {\fontsize{16}{20}\selectfont 04/12} \hfill \sffamily\textbf{\fontsize{16}{20}\selectfont April} \par
\rule{\linewidth}{0.1cm} \par
